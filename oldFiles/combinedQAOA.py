...
def decomp(aCopyG, lim):
   cutSet = sorted(list(nx.minimum_node_cut(aCopyG)))
   tGraph = aCopyG.copy()
   tGraph.remove_nodes_from(cutSet)
   seps = sorted(list(nx.connected_components(tGraph)), key=len, reverse=True)
   sepsv1 = []
   sepsv2 = []
   i = 0
   print(seps)
...
if __name__ == "__main__":
   ...
   #thisG.add_edges_from([(0,1),(0,2),(1,3),(2,3),(1,4),(2,4),(3,4),(3,5),(4,5)])
   #thisG.add_edges_from([(0,1),(0,2),(1,2),(1,3),(3,4),(2,4)])
