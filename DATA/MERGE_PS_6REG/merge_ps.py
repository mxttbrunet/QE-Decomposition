...
(6-regular -> min node cut ~6, so |K|>3 rounds -- where the merge fires -- are
the common/dominant case, making this the highest-degree stress test of the
merge step to date.)
